      ...
      <div className="p-4 space-y-6">
        ...
        <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <i className="fas fa-upload text-blue-400 text-2xl mb-2 block"></i>
              <div className="text-white font-medium">Upload CSV/PDF</div>
              <div className="text-slate-400 text-xs">Upload job files & create assignments</div>
            </button>
