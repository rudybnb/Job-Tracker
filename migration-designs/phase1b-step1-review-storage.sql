-- Dormant Phase 1B Step 1 design. This file is intentionally outside the registered migrations directory.
-- The review table records ONLY human review decisions against accepted Jarvis shadow changes.
